...
OUT_PATH = "cache/joke_explanations_qwen_audio_only.jsonl"
...
AUDIO_ONLY_PROMPT = """Listen to the following spoken audio and explain the joke.
...
def main():
    ...
    print("=== Explaining jokes (Audio Only) ===")
